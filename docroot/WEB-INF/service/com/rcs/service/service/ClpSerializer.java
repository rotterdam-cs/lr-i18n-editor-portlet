...
public class ClpSerializer {
		...
		synchronized (ClpSerializer.class) {
			...
			try {
				...
				String portletPropsServletContextName = (String)getMethod.invoke(null,
						"lr-i18n-editor-portlet-deployment-context");
			...
			if (Validator.isNull(_servletContextName)) {
				_servletContextName = "lr-i18n-editor-portlet";
			}
	...
	public static Object translateInput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals(MessageSourceClp.class.getName())) {
			return translateInputMessageSource(oldModel);
		}
	...
	public static Object translateOutput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals(
					"com.rcs.service.model.impl.MessageSourceImpl")) {
			return translateOutputMessageSource(oldModel);
		}
